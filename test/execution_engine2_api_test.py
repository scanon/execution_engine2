...
class ExecutionEngine2SchedulerTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.config = {}
        cls.config['mongo-host'] = cls.config_parser.get(section='execution_engine2', option='mongo-host')
        cls.config['mongo-database'] = cls.config_parser.get(section='execution_engine2', option='mongo-database')
        cls.config['mongo-user'] = cls.config_parser.get(section='execution_engine2',
                                                             option='mongo-user')
        cls.config['mongo-password'] = cls.config_parser.get(section='execution_engine2',
        ...
        cls.config['catalog-url'] = cls.config_parser.get(section='execution_engine2',
                                                         option='catalog-url')


        cls.config['workspace-url'] = cls.config_parser.get(section='execution_engine2',
