...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_execution_engine2.check_jobs_date_range,
                             name='execution_engine2.check_jobs_date_range',
                             types=[dict])
        self.method_authentication['execution_engine2.check_jobs_date_range'] = 'required'  # noqa
